...
import operaciones.OperacionesBasicas; //importamos la biblioteca
...
public class VentanaCalculadora extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        display.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(51, 204, 255)));
    ...
    private void jButton15ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton15ActionPerformed
        ...
        switch(operador){
            case "+": 
                display.setText( Integer.toString( op.sumar(numero1, numero2) ) );                 
                break;
            case "-": 
                display.setText( Integer.toString( op.restar(numero1, numero2) ) ); 
                break;
            case "*": 
                display.setText( Integer.toString( op.multiplicar(numero1, numero2) ) ); 
                break;
            case "/":
                int resultado = op.dividir(numero1, numero2);
                
                if( resultado == 0 ){
                    JOptionPane.showMessageDialog(this, "Error, intenta dividir un número entre cero!");
                    display.setText("");
                }else{
